			...
			<div className='py-12 sm:py-16 md:py-24'>
				<Container>
					<div className='text-center mb-12 sm:mb-16 animate-fade-in px-4 sm:px-0'>
						<h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent mb-4 sm:mb-6 animate-slide-up'>
